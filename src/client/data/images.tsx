...
import blogImage from "./../media/assets/pics/prezentareCarbune/blogs/dermatita.jpg";
import blogsBannerBg from "./../media/assets/pics/prezentareCarbune/blogs/blogsBannerBg.png";
